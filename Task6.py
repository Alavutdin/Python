...
##Написать программу  для бинарного поиска. На вход подаётся целочисленный
# массив ичисло. На выходе - индекс элемента или -1, в случае если
...
def main():
    # На вход будем подавать целочисленный массив
    arr = [1, 2, 7, 6, 11, 33, 45]

    print(f"Исходный массив : {arr}")
    number = int(input("Вводим искомый элемент: "))
